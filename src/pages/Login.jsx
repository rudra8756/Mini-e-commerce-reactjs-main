         ...
         <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
            <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
               <div className="p-4 py-6 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
                  ...
                  <p className="mt-6 font-normal text-center text-gray-300 md:mt-0">Your one-stop shop for everything!</p>
                  <p className="flex flex-col items-center justify-center mt-10 text-center">
                     <span>Don't have an account?</span>
                     <a href="/register" className="underline">Get Started!</a>
                  </p>
                  <p className="mt-6 text-sm text-center text-gray-300">Read our terms and conditions</p>
               </div>
                  ...
                  <form className="flex flex-col space-y-5">
                     ...
                     <div className="flex flex-col space-y-5">
                        ...
                        <div className="flex flex-col space-y-4">
                           <button onClick={googlewithlogin} type="button" className="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-gray-800 rounded-md group hover:bg-gray-800 focus:outline-none">
